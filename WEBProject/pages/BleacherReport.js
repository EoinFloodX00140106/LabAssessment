...
// Get your own key!
const apiKey = 'f7308b5e4f3e42068e6381812209dc20';
const defaultNewsSource = 'bleacher-report';
    ...
    render() {
      ...
      return (
        <div>
          ...
          <h3>Click away from sports news</h3>
          <ul className="newsMenu">
         
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=US">Top News headlines in America</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=US&category=business">Top Buisness headlines in America</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=Stock">Stock Market News</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=US&category=technology">Technology News in America</a></li>
